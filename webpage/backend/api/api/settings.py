...
SECRET_KEY = '*43d(sbiktuz!9k%t^r^dp@iw%4t)a!x@_6gj!hkj8z+jnp9=!'
...
DATABASES = {
    'default': {
        ...
        # Use the WSL IP address provided in Windows' ipconfig output, as this is where the DB is hosted. This changes on each reboot!
